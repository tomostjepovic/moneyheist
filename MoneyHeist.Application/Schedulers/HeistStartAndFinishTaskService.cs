...
{
    public class HeistStartAndFinishTaskService : BackgroundService
    {
        private readonly IServiceScopeFactory serviceScopeFactory;
        private Timer _timer;

        public HeistStartAndFinishTaskService(IServiceScopeFactory _serviceScopeFactory)
        {
        ...
        private async void DoWork(object state)
        {
            ...
            await heistService.StartHeists();
            await heistService.FinishHeists();
        }
